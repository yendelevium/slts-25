...
export default function Accompany() {
    ...
    return (
        <div className="mb-5 bg-white rounded-lg shadow-sm p-6">
            <FieldGroup>
            <FieldSet>
                <FieldLegend>Accompanying Adults/Non-Participating Siblings</FieldLegend>
                <FieldDescription>
                Information about adults and non-participating siblings accompanying the student
                </FieldDescription>
                    ...
                    {formData.adultsAccompanying == "yes" &&
                        <FieldSet>
                            ...
                            <FieldSet>
                                ...
                                <FieldDescription>
                                    Information about the point of contact for all accompanying members
                                </FieldDescription>
                                    ...
                                    {/* Name, Phone */}
                                        <Field>
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => debouncedFormUpdate("pocName", e.target.value)}
                                            />
                                        </Field>
                                    </div>
                                    ...
                                    <div className="flex-1">
                                        <Field>
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => debouncedFormUpdate("pocPhone", e.target.value)}
                                            />
                                        </Field>
                                    </div>
                                </div>
								...
								>
									...
									<div className="flex items-center gap-3">
										<RadioGroupItem value="Legal Guardian" id="Legal Guardian" />
