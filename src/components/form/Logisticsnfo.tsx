    ...
    <div className="mb-5 bg-white rounded-lg shadow-sm p-6">
      <FieldGroup>
        <FieldSet>
          ...
          <FieldDescription>
            Please enter the CORRECT information about arrival and departure information
          </FieldDescription>
          <FieldGroup>
            ...
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <Field>
                ...
                <Popover open={openArrivalDate} onOpenChange={setOpenArrivalDate}>
              ...
              <Field>
                ...
                <Input
                  ...
                  onChange={(e) => debouncedFormUpdate('arrivalTime', e.target.value)}
            ...
            <Field>
              ...
              <RadioGroup 
                ...
                onValueChange={(val) => {
                  ...
                  if (val === "no") {
                    updateForm({ needPickup: val, arrivalMode: "", pickupPoint: "" })
                  } else {
            ...
            {formData.needPickup === "yes" && (
              ...
              <Field>
                ...
                <Input type="text" placeholder="Landmark" id="pickup-point" defaultValue={formData.pickupPoint} onChange={(e)=> debouncedFormUpdate("pickupPoint", e.target.value)}/>
              </Field>
              </>
            )}
